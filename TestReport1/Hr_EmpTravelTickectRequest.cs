...
namespace TestReport1
{
    ...
    public partial class Hr_EmpTravelTickectRequest
    {
        ...
        public string Reserverd_Type { get; set; }
        public Nullable<decimal> Reserverd_Value { get; set; }
        public Nullable<decimal> Actuall_Value { get; set; }
